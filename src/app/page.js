...
export default function Home() {
  return (
    <main className="relative flex flex-col items-center justify-between bg-offWhite h-[calc(100vh-50px)]">
     
      <Image
          src={Vector17}
          alt=""
          className="absolute top-[400px] md:top-[65%] md:translate-y-[-50%] lg:top-[50%] lg:translate-y-[-50%] left-0 w-[182px] md:w-[260px] lg:w-[300px]"
        />
        <Image
          src={Vector13}
          alt=""
          className="absolute top-[30px] md:top-[50px] right-0 w-[152px] md:w-[200px] lg:w-[270px]"
        />
        <div className="flex flex-col items-center absolute top-[40%] translate-y-[-50%]">
      ...
      <div className="bg-mudGreen text-white w-full pt-[43px] md:pt-[54px] pb-[30px] md:pb-[40px] absolute bottom-0">
